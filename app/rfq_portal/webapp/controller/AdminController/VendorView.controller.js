sap.ui.define([
...
], (BaseController, MessageToast, fioriLibrary, XMLView, Filter, FilterOperator) => {
    "use strict";
    ...
    return BaseController.extend("rfqportal.controller.VendorView", {
        ...
        onInit() {
            ...
            oRouter.getRoute("RouteVendor").attachPatternMatched(this._onRouteMatched, this);
        },
        ...
        _bindVendorTable() {
            ...
            oTable.bindItems({
                ...
                parameters: {
                    ...
                    select: "ID,name,email,country,status,created_at,contactPerson,phone,address,website,rfqCount,quotationCount"
                }
            });
        },
        ...
        _showVendorDetail(sVendorId, oBindingContext) {
            ...
            if (!this._oVendorDetailView) {
                XMLView.create({
                    ...
                    viewName: "rfqportal.view.VendorDetail"
                }).then((oDetailView) => {
