    ...
    return BaseController.extend("rfqportal.controller.VendorDetail", {
        ...
        _loadVendorRFQs(sVendorId) {
            ...
            if (oRFQTable) {
                ...
                oRFQTable.bindItems({
                    path: "/VendorRFQs",
                    filters: [new Filter("supplier_id_ID", FilterOperator.EQ, sVendorId)],
        ...
        onDelete() {
            ...
            if (oContext) {
                ...
                MessageToast.show(`Delete vendor: ${sVendorName} - Not implemented yet`);
            }
        },
        ...
        handleClose() {
            ...
            if (oParentView && oParentView.getController && oParentView.getController().onCloseDetail) {
